...
for (int i = 0; i < smoothingArray; i++)
readingsX[i] = 0;
for (int i = 0; i < smoothingArray; i++)
readingsY[i] = 0;
for (int i = 0; i < smoothingArray; i++)
...
if (pitcher < -100) pitcher = -110;
if (roller > 100) roller = 110;
if (roller < -100) roller = -110;

// Serial.print("acc:");
Serial.print(roller, DEC); // used to be accel_x_axis
Serial.print(", ");
Serial.print(pitcher, DEC); // used to be accel_y_axis
Serial.print(", ");
Serial.print(avgAccelX, DEC); // used to be accel_z_axis,
Serial.print(", ");
// Serial.print("\t");

// Serial.print("joy:");
Serial.print(avgAccelY, DEC); // used to be joy_x_axis,
Serial.print(", ");
Serial.print(avgAccelZ, DEC); // used to be joy_y_axis,
...
// Serial.print("values scaled ");
// Serial.print(joyXs);
// Serial.print(" , ");
// Serial.print(joyYs);

// compute the X values and get the output stable
...
// Serial.print(" joyXs ");
// Serial.print(joyXs);
int valXneg = -1 * joyXneg;
// Serial.print(" valXneg ");
// Serial.print(valXneg);
valXneg = pwmMax*((valXneg - DEBOUNCE)/(joyXmin - DEBOUNCE));
// Serial.print(" newValXneg ");
// Serial.print(valXneg);
if (valXneg >= 255) {
valXneg = 255; }
...
// Serial.print(" joyYs ");
// Serial.print(joyYs);
int valYneg = -1 * joyYneg;
// Serial.print(" valYneg ");
// Serial.print(valYneg);
valYneg = pwmMax * (valYneg - DEBOUNCE) / (joyYmin - DEBOUNCE);
// Serial.print(" NewValYneg ");
// Serial.print(valYneg);
if (valYneg >= 255) {
valYneg = 255; }
...
// {
// analogWrite(ledpin, valXpos); // sets the value (range from 0 to 255)
// delay(3); // waits for 30 milli seconds to see the dimming effect
// }
